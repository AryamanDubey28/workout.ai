        ...
        <div className="space-y-4">
          ...
          <div>
            <input
              ...
              className="w-full px-4 py-3 text-base border rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary"
            />
          </div>
          ...
          <div>
            <div className="flex gap-3 items-center">
              <Button
                ...
                className="px-4 py-3 text-sm font-medium shrink-0 h-12 min-w-[80px]"
              ...
              {exercise.weight !== 'BW' && (
                <input
                  ...
                  className="flex-1 px-4 py-3 text-base border rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary h-12"
                />
              )}
            </div>
            {exercise.weight === 'BW' && (
