              ...
              <div className="flex items-center gap-2 mb-2">
                {isEditingTime ? (
                  <input
                    ...
                    autoFocus
                    className="h-6 rounded border border-input bg-background px-1.5 text-xs text-base focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
                  />
                ) : (
                  <button
                    onClick={() => {
